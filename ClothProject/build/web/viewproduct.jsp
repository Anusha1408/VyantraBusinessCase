                    ...
                    <jsp:include page="side1.jsp"></jsp:include>
                        ...
                        <%
                            ...
                            if (request.getParameter("companyid") != null) {
                                ...
                                allProducts = ProductInfoDAO.getAllProductByCompanyID(companyid);
                            } else {
                                allProducts = new ProductInfoDAO().getAllRecord();
                            }
                            ...
                            if (allProducts != null) {
                                ...
                                out.println("<h2>No Products Available for This Brand.</h2>");
                            }
                        %>
